...
set_property IOSTANDARD LVCMOS33 [get_ports U0]
...
set_property IOSTANDARD LVCMOS33 [get_ports S0A]
set_property PACKAGE_PIN W11 [get_ports {S0B}];  # "JB2"
set_property IOSTANDARD LVCMOS33 [get_ports S0B]
set_property PACKAGE_PIN V10 [get_ports {S1A}];  # "JB3"
set_property IOSTANDARD LVCMOS33 [get_ports S1A]
set_property PACKAGE_PIN W8 [get_ports {S1B}];  # "JB4"
set_property IOSTANDARD LVCMOS33 [get_ports S1B]
set_property PACKAGE_PIN V12 [get_ports {S2A}];  # "JB7"
set_property IOSTANDARD LVCMOS33 [get_ports S2A]
set_property PACKAGE_PIN W10 [get_ports {S2B}];  # "JB8"
set_property IOSTANDARD LVCMOS33 [get_ports S2B]
set_property PACKAGE_PIN V9 [get_ports {Motor_up}];  # "JB9"
set_property IOSTANDARD LVCMOS33 [get_ports Motor_up]
set_property PACKAGE_PIN V8 [get_ports {Motor_down}];  # "JB10"
set_property IOSTANDARD LVCMOS33 [get_ports Motor_down]

# ----------------------------------------------------------------------------
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB6 [get_ports {test_out[0]}];  # "JC1_N"
set_property IOSTANDARD LVCMOS33 [get_ports {test_out[0]}]
set_property PACKAGE_PIN AB7 [get_ports {test_out[1]}];  # "JC1_P"
set_property IOSTANDARD LVCMOS33 [get_ports {test_out[1]}]
set_property PACKAGE_PIN AA4 [get_ports {test_out[2]}];  # "JC2_N"
set_property IOSTANDARD LVCMOS33 [get_ports {test_out[2]}]
set_property PACKAGE_PIN Y4  [get_ports {test_out[3]}];  # "JC2_P"
set_property IOSTANDARD LVCMOS33 [get_ports {test_out[3]}]
set_property PACKAGE_PIN T6  [get_ports {test_out[4]}];  # "JC3_N"
set_property IOSTANDARD LVCMOS33 [get_ports {test_out[4]}]
set_property PACKAGE_PIN R6  [get_ports {test_out[5]}];  # "JC3_P"
set_property IOSTANDARD LVCMOS33 [get_ports {test_out[5]}]
set_property PACKAGE_PIN U4  [get_ports {test_out[6]}];  # "JC4_N"
set_property IOSTANDARD LVCMOS33 [get_ports {test_out[6]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports LED_U0]
set_property PACKAGE_PIN T21 [get_ports {LED_U1}];  # "LD1"
set_property IOSTANDARD LVCMOS33 [get_ports LED_U1]
...
set_property IOSTANDARD LVCMOS33 [get_ports LED_B0]
set_property PACKAGE_PIN W22 [get_ports {LED_B1}];  # "LD5"
set_property IOSTANDARD LVCMOS33 [get_ports LED_B1]
set_property PACKAGE_PIN U19 [get_ports {LED_B2}];  # "LD6"
set_property IOSTANDARD LVCMOS33 [get_ports LED_B2]
